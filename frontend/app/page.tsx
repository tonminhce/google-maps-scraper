  ...
  return (
    <main className="min-h-screen py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <footer className="mt-12 sm:mt-16 text-center pb-8">
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 inline-block shadow-lg border border-slate-200">
            <p className="text-slate-600 text-sm sm:text-base mb-2">
              Made with{' '}
              <span className="text-rose-500 inline-block animate-pulse">❤️</span>{' '}
              for food lovers in Sài Gòn
            </p>
